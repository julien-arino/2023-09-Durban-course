...
% \vfill
% - Indeed their effects were devastating at a time when medicine virtually did not exist and thus were easily observed
% \end{frame}
% 
% \begin{frame}{First known epidemics (\href{https://en.wikipedia.org/wiki/List_of_epidemics}{from Wikipedia})}
% 
% \footnotesize
% \begin{tabular}{p{1.5cm}p{1.5cm}p{2cm}p{2cm}p{2cm}}
% Event & Date & Location & Disease & Death toll (estimate) \\
% \hline
% Plague of Megiddo & 1350 BCE & Megiddo, land of Canaan & Unknown & Unknown \\
% \href{https://en.wikipedia.org/wiki/Plague_of_Athens}{Plague of Athens} & 429–426 BCE & Greece, Libya, Egypt, Ethiopia & Possibly typhus, typhoid fever or VHF &  75,000–100,000 \\
...
% %%%%%%%%%%%%%%%%%%%%
% %%%%%%%%%%%%%%%%%%%%
% \subsection{Unfortunately epidemics are not yet historical}
...
% \end{frame}
% 
% \begin{frame}{Invariance of $\IR_+^2$ under the flow (3)} 
...
\begin{frame}
As you can probably guess, if $\R_0>1$, then $\bE_\star$ is not only biologically relevant by actually also LAS
\vfill
Recall the Jacobian
\begin{equation}
