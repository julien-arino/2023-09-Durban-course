...
<<KMK_R0eq1dot5,eval=TRUE,echo=FALSE,fig=TRUE,width=8,height=4,include=FALSE>>=
library(latex2exp)
plot(sol[, "time"], sol[, "I"], 
     type = "l", lwd = 2,
...
\end{lstlisting}
\begin{center}
\includegraphics[width=\textwidth]{lecture-01-introduction-math-epi-KMK_R0eq1dot5}
\end{center}
\end{frame}
