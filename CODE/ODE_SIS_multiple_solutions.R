...
# Initial conditions. It is useful to have named variables ((S=.., 
# I=..), here, so that the algorithm knows which variables it is being passed 
# (otherwise, you will need to write something like S=x[1], etc.)
